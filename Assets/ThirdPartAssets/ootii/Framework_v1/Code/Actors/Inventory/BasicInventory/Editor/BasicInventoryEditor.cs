...
public class BasicInventoryEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorHelper.DrawInspectorDescription("Very basic inventory solution used as an example. This simply implements IInventorySource or you can replace it with your inventory solution.", MessageType.None);
