	...
	public class Layout
	{
		...
		#region Fields
			...
			public T Field<T> (
				...
				bool handles = false, //for moving Vector2 with the position handle
				GUIStyle style = null, 
				string tooltip=null)
			{
				//finding current params
			...
			//	GUI.SetNextControlName("LayoutField");
				...
				else if (type == typeof(Vector2)) 
				{
					...
					if (handles)
					{
						//Vector3 hpos = UnityEditor.Handles.PositionHandle( new Vector3(val.x,0,val.y),  Quaternion.identity );
						//val = new Vector2(pos.x, pos.z);
					}
